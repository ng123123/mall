...
public class ConfirmOrderResult {
    //包含优惠信息的购物车信息
    private List<MemberCartPromotionItem> cartPromotionItemList;
    //用户收货地址列表
    ...
    public List<MemberCartPromotionItem> getCartPromotionItemList() {
        return cartPromotionItemList;
    }

    public void setCartPromotionItemList(List<MemberCartPromotionItem> cartPromotionItemList) {
